...
void World::major_invalidate_mesh(glm::ivec3 position)
{
  dimension.major_invalidate_mesh(position);
}

void World::minor_invalidate_mesh(glm::ivec3 position)
{
  dimension.minor_invalidate_mesh(position);
}

void World::lighting_invalidate(glm::ivec3 position)
{
